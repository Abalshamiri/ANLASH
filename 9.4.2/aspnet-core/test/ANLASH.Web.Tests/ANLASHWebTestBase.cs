...
{
    public abstract class ANLASHWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ANLASHWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ANLASHWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ANLASHDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ANLASHDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ANLASHDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ANLASHDbContext, Task<T>> func)
        {
            T result;
